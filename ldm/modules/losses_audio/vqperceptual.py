...
# Adapted from https://github.com/CompVis/latent-diffusion/blob/main/ldm/modules/losses/vqperceptual.py under the MIT license
...
from ldm.modules.losses_audio.discriminator import NLayerDiscriminator, weights_init
